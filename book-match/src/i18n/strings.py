...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "layer1.search.placeholder": "Type a title or author…",
        ...
        "layer1.search.add_as_typed": 'Add "{query}" as typed',
        "layer1.search.backend_unavailable": "Live suggestions unavailable right now — you can still add books as typed.",
        ...
        "layer2.plot_character": "Character-driven ←→ Plot-driven",
        "layer2.plot_character.low": "Character-driven",
        "layer2.plot_character.high": "Plot-driven",
        "layer2.pace": "Slow-paced ←→ Fast-paced",
        "layer2.pace.low": "Slow-paced",
        "layer2.pace.high": "Fast-paced",
        "layer2.complexity": "Simple / straightforward ←→ Intricate / complex",
        "layer2.complexity.low": "Simple / straightforward",
        "layer2.complexity.high": "Intricate / complex",
        "layer2.length": "Length",
        "layer2.length.short": "Short",
        "layer2.length.medium": "Medium",
        "layer2.length.long": "Long",
        "layer2.tone": "Dark and serious ←→ Light and hopeful",
        "layer2.tone.low": "Dark and serious",
        "layer2.tone.high": "Light and hopeful",
